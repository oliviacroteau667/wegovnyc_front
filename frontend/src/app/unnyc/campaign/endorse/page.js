...
/**
 * /unnyc/campaign/endorse — the formal-commitment path, distinct from the
 * public open letter at /unnyc/campaign/sign. Two things happen here:
            ...
            <header className="unnyc-cmp-header">
                <div className="unnyc-cmp-container">
                    ...
                    <div className="unnyc-cmp-header__actions">
                        <Link
                            href="/unnyc/campaign/endorse/document"
            ...
            <article className="unnyc-cmp-letter">
                <div className="unnyc-cmp-container unnyc-cmp-container--narrow">
                    ...
                    <p>
                        ...
                        <Link href="/unnyc/campaign/endorse/document">
