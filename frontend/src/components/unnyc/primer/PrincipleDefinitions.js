        ...
        <section id="principles" className="unnyc-section unnyc-section--alt">
            <div className="unnyc-container">
                <header className="unnyc-section__header">
                    ...
                    <Link href="/unnyc/start/principles" className="unnyc-btn unnyc-btn--outline-dark">
                        View as PDF ↗
                    </Link>
                </header>
                ...
                <div className="unnyc-start-principles__cta">
                    <Link href="/unnyc/campaign/sign" className="unnyc-btn unnyc-btn--primary">
